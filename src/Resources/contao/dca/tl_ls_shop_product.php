...
$GLOBALS['TL_DCA']['tl_ls_shop_product'] = array(
	...
	'fields' => array(
		...
		'lsShopProductSalesUnitSize' => [
			'label' => &$GLOBALS['TL_LANG']['tl_ls_shop_product']['lsShopProductSalesUnitSize'],
			'exclude' => true,
			'inputType' => 'text',
			'eval' => [
				'rgxp' => 'digit',
		...
		'lsShopProductSalesUnit' => [
			'label' => &$GLOBALS['TL_LANG']['tl_ls_shop_product']['lsShopProductSalesUnit'],
			'exclude' => true,
			'inputType' => 'text',
			'eval' => [
				'tl_class' => 'w50',
		...
		'lsShopProductMoreImages' => array(
			...
			'eval'			=> [
                ...
                'files' => true,
                'filesOnly' => true,
                'extensions' => 'jpg,JPG,jpeg,JPEG,png,PNG,gif,GIF,webp,WEBP,flv,mp4,mp2,swf,mov,avi',
                'tl_class' => 'clr'
            ],
            'sql'                     => "blob NULL"
		),
