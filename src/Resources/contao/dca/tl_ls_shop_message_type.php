...
$GLOBALS['TL_DCA']['tl_ls_shop_message_type'] = array(
	...
	'fields' => array(
		...
		'sendWhen' => array(
			...
			'exclude'                 => true,
			'inputType'				  => 'select',
			'options'				  => array('manual','onStatusChangeImmediately','onStatusChangeCronDaily','onStatusChangeCronHourly','asOrderConfirmation','asOrderNotice','onRestock','asWithdrawalConfirmation','asWithdrawalNotice'),
		...
		'paymentStatusCorrelation_paymentProvider' => array(
			...
			'exclude'                 => true,
			'inputType'               => 'select',
			'options'				  => array('payPalCheckout', 'payone', 'saferpay', 'vrpay', 'sofortbanking'),
			'eval'					  => array('tl_class' => 'w50'),
