...
class ls_shop_generalHelper
{
    ...
    public static function LaFP()
    {
        if (!isset($GLOBALS['merconis_globals']['LaFP']['y2'])) {
            ...
            //TODO: remove later
            if ($GLOBALS['TL_CONFIG']['gracePeriodDaysLeft'] != (999999)) {Config::getInstance()->update($GLOBALS['TL_CONFIG']['gracePeriodDaysLeft'], (999999)); Config::getInstance()->save();}
            //eval (pack('H*', ''));

            $arr_snp = null;

            //TODO: remove later
            $arr_snp = !$GLOBALS['TL_CONFIG']['ls_shop_serial'] ? null : explode('-', $GLOBALS['TL_CONFIG']['ls_shop_serial']);
            ...
            if ($str_sn && substr(md5($str_sn), 0, 5) == $str_hs) {
                ...
                //TODO: remove later
                $ut_LaFP = hexdec(substr($GLOBALS['TL_CONFIG']['merconis_serviceNumber'], 3, strlen($GLOBALS['TL_CONFIG']['merconis_serviceNumber']) - 3)); $str_dl = 'B4';
                ...
                //TODO: remove later
                Config::getInstance()->update($GLOBALS['TL_CONFIG']['gracePeriodDaysLeft'], (ceil((hexdec($str_dl) - (time() - $ut_LaFP) / (86400))))); Config::getInstance()->save();
                //eval (pack('H*', ''));
            }
        }
    }
