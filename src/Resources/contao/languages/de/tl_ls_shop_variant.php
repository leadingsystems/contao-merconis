...
$GLOBALS['TL_LANG']['tl_ls_shop_variant']['lsShopVariantPriceOldIsUvp']							= array('Alter Preis ist UVP', 'Markieren Sie diese Option, wenn es sich beim Vergleichspreis um eine UVP handelt. In diesem Fall ist keine Angabe des 30-Tage-Niedrigstpreises erforderlich.');
$GLOBALS['TL_LANG']['tl_ls_shop_variant']['use30DayLowestPrice']									= array('30-Tage-Niedrigstpreis verwenden');
$GLOBALS['TL_LANG']['tl_ls_shop_variant']['lsShopVariantPrice30DayLowest']						= array('30-Tage-Niedrigstpreis','Geben Sie hier den 30-Tage-Niedrigstpreis für diese Variante ein. Bitte definieren Sie die Art der Preisangabe im nebenstehenden Auswahlfeld.');
$GLOBALS['TL_LANG']['tl_ls_shop_variant']['lsShopVariantPriceType30DayLowest']					= array('30-Tage-Niedrigstpreis: Art der Preisangabe');
