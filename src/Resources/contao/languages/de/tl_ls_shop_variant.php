...
$GLOBALS['TL_LANG']['tl_ls_shop_variant']['lsShopVariantSalesUnitSize']						=	array('abweichende Stück pro Verkaufseinheit', 'Nur falls abweichend vom Hauptprodukt: Geben Sie hier die Anzahl der Stück ein, die eine Verkaufseinheit dieser Variante bildet. Der Wert "0" übernimmt die VE-Größe des Hauptproduktes; ist dort ebenfalls "0" gesetzt, bleibt der VE-Modus inaktiv.');
$GLOBALS['TL_LANG']['tl_ls_shop_variant']['lsShopVariantSalesUnit']							=	array('abweichende Stückbezeichnung der Verkaufseinheit', 'Nur falls abweichend vom Hauptprodukt: Tragen Sie hier die mehrsprachige Stückbezeichnung der Verkaufseinheit (z. B. "Stk.") ein. Bleibt das Feld leer, greift zuerst die Produktangabe und danach die globale Standard-Stückbezeichnung aus den Shop-Grundeinstellungen.');
$GLOBALS['TL_LANG']['tl_ls_shop_variant']['lsShopVariantMinimumOrderQuantity']				=	array('abweichende Mindestbestellmenge', 'Nur falls abweichend vom Hauptprodukt: Geben Sie hier die kleinste bestellbare Gesamtmenge pro Warenkorbposition in internen Mengeneinheiten ein. Der Wert "0" übernimmt die Mindestbestellmenge des Hauptproduktes; ist dort ebenfalls "0" gesetzt, bleibt die Mindestbestellmenge inaktiv. Bei aktivem VE-Modus bezieht sich der Wert auf Verkaufseinheiten.');
