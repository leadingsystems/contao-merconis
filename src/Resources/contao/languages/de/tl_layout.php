<?php
    ...
    $GLOBALS['TL_LANG']['tl_layout']['ls_shop_removeImpossibleFilterOptions'] = array('Unmögliche Filteroptionen verbergen', 'Entfernt Filteroptionen, die mit der aktuellen Auswahl keine Treffer ergeben können.');
