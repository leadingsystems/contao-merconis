...
$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText026'] = 'Steuersatz';
...
$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText097'] = 'Anwenden';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText097-02'] = 'Sie können diese Produktliste filtern!';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText097-03'] = 'Sie filtern nach %s Merkmalen';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText097-04'] = 'Sie filtern nach %s Merkmal';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText097-05'] = 'Alle Filtermöglichkeiten';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['miscText097-06'] = 'Filtern nach';
...
$GLOBALS['TL_LANG']['MSC']['ls_shop']['currentlyNotAvailable'] = 'Zurzeit nicht auf Lager';
...
$GLOBALS['TL_LANG']['MSC']['ls_shop']['misc']['uvp'] = 'UVP';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['misc']['thirtyDayLowestPriceInfo'] = 'Niedrigster Preis der letzten 30 Tage: %s Sie sparen %s gegenüber dem Bestpreis der letzten 30 Tage.';
...
$GLOBALS['TL_LANG']['MSC']['ls_shop']['misc']['importErrors'] = array(
	...
	'notExistingPriceType' => 'In der/den Zeile(n) fehlt im Feld "Preis: Art der Preisangabe" ein erforderlicher Modifikationstyp oder es wurde ein ungültiger Wert angegeben: Nr. %s',
	'notExistingPriceTypeOld' => 'In der/den Zeile(n) fehlt im Feld "Alter Preis: Art der Preisangabe" ein erforderlicher Modifikationstyp oder es wurde ein ungültiger Wert angegeben: Nr. %s',
	'notExistingPriceType30DayLowest' => 'In der/den Zeile(n) fehlt im Feld "30-Tage-Niedrigstpreis: Art der Preisangabe" ein erforderlicher Modifikationstyp oder es wurde ein ungültiger Wert angegeben: Nr. %s',
	'notExistingWeightType' => 'In der/den Zeile(n) fehlt im Feld "Art der Gewichtsangabe" ein erforderlicher Modifikationstyp oder es wurde ein ungültiger Wert angegeben: Nr. %s',
...
$GLOBALS['TL_LANG']['MOD']['ls_shop']['paymentMethods']['payPalCheckout']['captureStatusDetailsInvalid'] = 'Zahlung wurde nicht durchgeführt. Bitte entnehmen Sie weitere Informationen aus Ihrem PayPal-Account.<br>(Zahlungsmeldung: %s)';
...
$GLOBALS['TL_LANG']['MSC']['ls_shop']['debugCoupon_productVariantID'] = 'Produkt Name (Produkt Varianten ID)';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['debugCoupon_valueOfGoods'] = 'Warenwert';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['debugCoupon_couponValue'] = 'Gutscheinwert';
$GLOBALS['TL_LANG']['MSC']['ls_shop']['debugCoupon_couponValueLeft'] = 'Gutscheinwert nach Benutzung für das Product';
