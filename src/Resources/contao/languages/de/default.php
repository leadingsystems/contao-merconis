...
$GLOBALS['TL_LANG']['MSC']['ls_shop']['misc']['thirtyDayLowestPriceInfoBasedOnUnitPrice'] = 'Niedrigster Preis der letzten 30 Tage: %s. Sie sparen %s gegenüber dem Bestpreis der letzten 30 Tage (bezogen auf den Einzelpreis).';
...
$GLOBALS['TL_LANG']['MSC']['ls_shop']['misc']['importErrors'] = array(
	...
	'valueInvalid_price30DayLowest' => 'Feldwert für "price30DayLowest" ist ungültig (muss ein Dezimalwert sein (0-9, Dezimalpunkt und Minuszeichen sind erlaubt)): Zeile(n) Nr. %s',
	'variantValueInvalid_price30DayLowest' => 'Feldwert für "price30DayLowest" ist ungültig (muss ein Dezimalwert sein (0-9, Dezimalpunkt und Minuszeichen sind erlaubt)): Zeile(n) Nr. %s',
