<?php
    ...
    $GLOBALS['TL_LANG']['tl_lsShopSettings']['ls_shop_systemImages_noProductImage']	= array('Standartbild für Produkte', 'Wählen Sie hier eine Grafik aus, die verwendet wird wenn kein Bild für ein Produkt ermittelt werden kann.');
