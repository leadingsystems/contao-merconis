<?php
	...
	$GLOBALS['TL_LANG']['tl_lsShopSettings']['ls_shop_productNotFound'] = array('Seite "Produkt nicht gefunden"', 'Wählen Sie hier die Seite aus, die angezeigt werden soll wenn das Produkt nicht gefunden werden konnte');
