<?php
	...
	$GLOBALS['TL_LANG']['tl_lsShopSettings']['ls_shop_salesUnit']				= array('Standard-Stückbezeichnung für Verkaufseinheiten', 'Tragen Sie hier die einsprachige Standard-Stückbezeichnung der Verkaufseinheit (z. B. "Stk.") ein. Dieser Wert dient nur als Fallback, wenn auf Produkt- und Variantenebene keine mehrsprachige Stückbezeichnung gepflegt wurde.');
	$GLOBALS['TL_LANG']['tl_lsShopSettings']['ls_shop_minimumOrderQuantityStockHandling']	= array('Verhalten bei Lagerbestand unter Mindestbestellmenge', 'Bestimmen Sie hier shopweit, wie sich Produkte verhalten, wenn der verfügbare Lagerbestand unter der aktiven Mindestbestellmenge liegt.');
	...
	$GLOBALS['TL_LANG']['tl_lsShopSettings']['ls_shop_minimumOrderQuantityStockHandling']['options'] = array(
		'denyOrder' => array('Nicht bestellbar', 'Das Produkt ist nicht bestellbar, wenn der verfügbare Lagerbestand die Mindestbestellmenge unterschreitet.'),
		'allowAvailableQuantity' => array('Verfügbare Menge erlauben', 'Das Produkt bleibt bestellbar. Der Kunde muss dann den gesamten verfügbaren Restbestand abnehmen, auch wenn dieser unter der eigentlichen Mindestbestellmenge liegt.')
	);
