<?php
	...
	$GLOBALS['TL_LANG']['tl_lsShopSettings']['ls_shop_defaultProductPage'] = array('Seite "Standard Produkt Seite"', 'Wählen Sie hier die Seite aus, auf der Produkte angezeigt werden die keinen oder nur ausgeblendeten Seiten zugeordnet sind');
