<?php
	...
	$GLOBALS['TL_LANG']['tl_lsShopSettings']['merconis_licenseKey']				= array('Lizenzschlüssel', 'Bitte tragen Sie hier den Lizenzschlüssel ein (signierter License Key oder Legacy-Seriennummer).');
	...
	$GLOBALS['TL_LANG']['tl_lsShopSettings']['ls_shop_cartPositionCommentsEnabled'] = ['Kommentarfeld für Warenkorb-Positionen aktivieren', 'Deaktivieren Sie diese Option, wenn Positions-Kommentare shopweit im aktiven Einkaufsfluss ausgeblendet und eingehende Kommentare ignoriert werden sollen. Bereits in abgeschlossenen Bestellungen gespeicherte Kommentare bleiben weiterhin sichtbar.'];
	...
	$GLOBALS['TL_LANG']['tl_lsShopSettings']['ls_shop_legalGuaranteeInfoPages'] = array('Seite "GLL-Infoseite"', 'Wählen Sie hier die Seite aus, auf der die Mitteilung über das gesetzliche Gewährleistungsrecht ausgegeben wird. Falls Sie einen mehrsprachigen Shop betreiben, wählen Sie bitte für jede Sprache die entsprechende Seite aus.');
	$GLOBALS['TL_LANG']['tl_lsShopSettings']['ls_shop_enableGllMigrationControl'] = array('GLL-Übernahme bestehender Produkte', 'Starten Sie hier einmalig die Übernahme, die bei allen bestehenden Produkten enableGll auf true setzt. Nach erfolgreichem Lauf bleibt der Knopf gesperrt, bis das Flag ls_shop_enableGllMigrationApplied aus der localconfig entfernt wird.');
	$GLOBALS['TL_LANG']['tl_lsShopSettings']['ls_shop_enableGllMigrationControl']['button'] = 'Übernahme starten';
	$GLOBALS['TL_LANG']['tl_lsShopSettings']['ls_shop_enableGllMigrationControl']['pending'] = 'Die Übernahme wurde noch nicht ausgeführt.';
	$GLOBALS['TL_LANG']['tl_lsShopSettings']['ls_shop_enableGllMigrationControl']['applied'] = 'Die Übernahme wurde bereits ausgeführt. Für einen erneuten Lauf muss das Flag ls_shop_enableGllMigrationApplied aus der localconfig entfernt werden.';
	$GLOBALS['TL_LANG']['tl_lsShopSettings']['ls_shop_enableGllMigrationControl']['success'] = '%s Produktdatensätze wurden auf enableGll = true gesetzt.';
	$GLOBALS['TL_LANG']['tl_lsShopSettings']['ls_shop_defaultProductPages'] = array('Seite "Standard Produkt Seite"', 'Wählen Sie hier die Seite aus, auf der Produkte angezeigt werden sollen, die keiner oder nur unveröffentlichten Seiten zugeordnet sind.');
	...
	$GLOBALS['TL_LANG']['tl_lsShopSettings']['legalGuarantee_legend'] = 'Gewährleistungslabel';
