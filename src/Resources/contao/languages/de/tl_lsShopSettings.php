<?php
    ...
    $GLOBALS['TL_LANG']['tl_lsShopSettings']['ls_shop_searchWeighting_debug'] = array('Debug Modus für Such-Gewichtung: Wenn angeschalten wird in der Produktsuche die Gewichtung der Produkte ausgegeben');
