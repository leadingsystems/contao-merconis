<?php
	...
	$GLOBALS['TL_LANG']['tl_ls_shop_product']['lsShopProductPriceOldIsUvp']						=	array('Alter Preis ist UVP', 'Markieren Sie diese Option, wenn es sich beim Vergleichspreis um eine UVP handelt. In diesem Fall ist keine Angabe des 30-Tage-Niedrigstpreises erforderlich.');
	$GLOBALS['TL_LANG']['tl_ls_shop_product']['lsShopProductPrice30DayLowest']					=	array('30-Tage-Niedrigstpreis in '.($GLOBALS['TL_CONFIG']['ls_shop_currency'] ? $GLOBALS['TL_CONFIG']['ls_shop_currency'] : '<i>&lt;noch keine Währung in den Grundeinstellungen definiert&gt;</i>'), 'Ob Sie hier einen Brutto- oder Nettopreis hinterlegen, hängt von der globalen Shop-Grundeinstellung ab.');
	$GLOBALS['TL_LANG']['tl_ls_shop_product']['use30DayLowestPrice']								=	array('30-Tage-Niedrigstpreis verwenden');
