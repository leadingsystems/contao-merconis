<?php
	...
	$GLOBALS['TL_LANG']['tl_ls_shop_product']['lsShopProductSalesUnitSize']						=	array('Stück pro Verkaufseinheit', 'Geben Sie hier die Anzahl der Stück ein, die eine Verkaufseinheit dieses Produktes bildet. Der Wert "0" deaktiviert den VE-Modus auf Produktebene und dient Varianten ohne eigene VE-Größe als Fallback.');
