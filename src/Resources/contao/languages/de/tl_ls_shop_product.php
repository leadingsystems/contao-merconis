<?php
	...
	$GLOBALS['TL_LANG']['tl_ls_shop_product']['lsShopProductSalesUnitSize']						=	array('Stück pro Verkaufseinheit', 'Geben Sie hier die Anzahl der Stück ein, die eine Verkaufseinheit dieses Produktes bildet. Der Wert "0" deaktiviert den VE-Modus auf Produktebene. Varianten ohne eigene VE-Größe erben den hier eingetragenen Wert.');
	$GLOBALS['TL_LANG']['tl_ls_shop_product']['lsShopProductSalesUnit']							=	array('Stückbezeichnung der Verkaufseinheit', 'Tragen Sie hier die mehrsprachige Stückbezeichnung der Verkaufseinheit (z. B. "Stk.") ein. Bleibt das Feld leer, greift die globale Standard-Stückbezeichnung aus den Shop-Grundeinstellungen, sofern auch auf Variantenebene kein Wert gesetzt ist.');
	$GLOBALS['TL_LANG']['tl_ls_shop_product']['lsShopProductMinimumOrderQuantity']				=	array('Mindestbestellmenge', 'Geben Sie hier die kleinste bestellbare Gesamtmenge pro Warenkorbposition in internen Mengeneinheiten ein. Der Wert "0" deaktiviert die Mindestbestellmenge auf Produktebene. Varianten ohne eigene Mindestbestellmenge (> 0) erben den hier eingetragenen Wert. Bei aktivem VE-Modus bezieht sich der Wert auf Verkaufseinheiten.');
	...
	$GLOBALS['TL_LANG']['tl_ls_shop_product']['customizerLogicFile']							=	array('Customizer-Datei anwenden');
