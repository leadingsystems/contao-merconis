...
$GLOBALS['TL_LANG']['tl_ls_shop_variant']['lsShopVariantPriceOldIsUvp']							= array('Old price is UVP', 'Check this option if the comparison price is an UVP. In this case, no 30-day lowest price information is required.');
$GLOBALS['TL_LANG']['tl_ls_shop_variant']['use30DayLowestPrice']									= array('Use 30-day lowest price');
$GLOBALS['TL_LANG']['tl_ls_shop_variant']['lsShopVariantPrice30DayLowest']						= array('30-day lowest price','Enter the 30-day lowest price for this variant here. Please define the type of price indication in the opposite choice box.');
$GLOBALS['TL_LANG']['tl_ls_shop_variant']['lsShopVariantPriceType30DayLowest']					= array('30-day lowest price: Type of price indication');
