...
$GLOBALS['TL_LANG']['tl_ls_shop_variant']['lsShopVariantSalesUnitSize']						=	array('Deviant pieces per sales unit', 'Only if different from the main product: Enter the number of pieces that make up one sales unit of this variant. The value "0" inherits the sales unit size from the main product; if it is also "0" there, sales-unit mode remains inactive.');
$GLOBALS['TL_LANG']['tl_ls_shop_variant']['lsShopVariantSalesUnit']							=	array('Deviant piece label of the sales unit', 'Only if different from the main product: Enter the multilingual piece label of the sales unit here (e.g. "pcs."). If the field stays empty, the product value is used first and afterwards the global default piece label from the shop settings.');
$GLOBALS['TL_LANG']['tl_ls_shop_variant']['lsShopVariantMinimumOrderQuantity']				=	array('Deviant minimum order quantity', 'Only if different from the main product: Enter the smallest orderable total quantity per cart item here in internal quantity units. The value "0" inherits the minimum order quantity from the main product; if it is also "0" there, the minimum order quantity remains inactive. When sales-unit mode is active, the value refers to sales units.');
