<?php
	...
	$GLOBALS['TL_LANG']['tl_ls_shop_product']['lsShopProductSalesUnitSize']						=	array('Pieces per sales unit', 'Enter the number of pieces that make up one sales unit of this product. The value "0" disables sales-unit mode on product level. Variants without their own sales unit size inherit the value entered here.');
	$GLOBALS['TL_LANG']['tl_ls_shop_product']['lsShopProductSalesUnit']							=	array('Piece label of the sales unit', 'Enter the multilingual piece label of the sales unit here (e.g. "pcs."). If the field stays empty, the global default piece label from the shop settings is used, provided no value is set on variant level either.');
	$GLOBALS['TL_LANG']['tl_ls_shop_product']['lsShopProductMinimumOrderQuantity']				=	array('Minimum order quantity', 'Enter the smallest orderable total quantity per cart item here in internal quantity units. The value "0" disables the minimum order quantity on product level. Variants without their own minimum order quantity (> 0) inherit the value entered here. When sales-unit mode is active, the value refers to sales units.');
    ...
    $GLOBALS['TL_LANG']['tl_ls_shop_product']['deliveryInfoSetToUseInPreorderPhase']            =   array('Stock/delivery time in pre-order phase', 'Define here different settings of stock and delivery conditions in the pre-order phase.');
