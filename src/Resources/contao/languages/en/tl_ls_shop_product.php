...
$GLOBALS['TL_LANG']['tl_ls_shop_product']['useGroupRestrictions']							=	array('Group Restrictions');
    ...
    $GLOBALS['TL_LANG']['tl_ls_shop_product']['variationGroupCode']								=	array('Belongs to variation group');
	...
	$GLOBALS['TL_LANG']['tl_ls_shop_product']['mpn']											=	array('MPN (Manufacturer Part Number)');
	$GLOBALS['TL_LANG']['tl_ls_shop_product']['gtin']											=	array('GTIN (8/12/13/14 digits)');
