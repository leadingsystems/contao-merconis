<?php
	...
	$GLOBALS['TL_LANG']['tl_ls_shop_product']['lsShopProductSalesUnitSize']						=	array('Pieces per sales unit', 'Enter the number of pieces that make up one sales unit of this product. The value "0" disables sales-unit mode on product level and serves as the fallback for variants without their own sales unit size.');
