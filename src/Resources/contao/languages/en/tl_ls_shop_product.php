<?php
	...
	$GLOBALS['TL_LANG']['tl_ls_shop_product']['lsShopProductPriceOldIsUvp']						=	array('Old price is UVP', 'Check this option if the comparison price is an UVP. In this case, no 30-day lowest price information is required.');
	$GLOBALS['TL_LANG']['tl_ls_shop_product']['lsShopProductPrice30DayLowest']					=	array('30-day lowest price in '.($GLOBALS['TL_CONFIG']['ls_shop_currency'] ? $GLOBALS['TL_CONFIG']['ls_shop_currency'] : '<i>&lt;No currency defined yet in the basic settings&gt;</i>'), 'It depends on the global basic shop setting whether a gross or net price is stored here.');
	$GLOBALS['TL_LANG']['tl_ls_shop_product']['use30DayLowestPrice']								=	array('Use 30-day lowest price');
