<?php
    ...
    $GLOBALS['TL_LANG']['tl_form_field']['lsShop_ShowOnConditionBoolean'] = array('Visible if condition does not apply');

/*
 * Misc
 */
	$GLOBALS['TL_LANG']['tl_form_field']['merconisCheckVATID'] = array('MERCONIS VATID validation');
