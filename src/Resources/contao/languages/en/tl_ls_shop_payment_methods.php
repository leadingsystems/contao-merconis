<?php
	...
	$GLOBALS['TL_LANG']['tl_ls_shop_payment_methods']['payone_subaccountId']						= array('PAYONE Sub account ID', 'Please enter the value here of which you learn when you have the API parameter tab displayed in the payment portal section of the PAYONE Merchant Interface. Please also ensure that the hash value check procedure is set correctly (md5 or sha2).');
