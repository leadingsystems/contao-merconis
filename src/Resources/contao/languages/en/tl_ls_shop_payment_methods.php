<?php
    ...
    */
    ...
    $GLOBALS['TL_LANG']['tl_ls_shop_payment_methods']['payPalCheckout_shipToFieldNameState']					= array('Field name in checkout form for "Federal state/region"', 'Please enter the field name of the respective input field in the checkout form here. If you use fields for an alternative dispatch address, please make sure to use the same field names for corresponding fields with the appended character string "_Alternative" at the end. If these values are not correctly transferred to PayPal, it might happen that you cannot take advantage of various PayPal service options. In this connection, please also make sure to define reasonable mandatory fields in the checkout form and to only permit values for the respective fields of which you know that PayPal will accept them.');
    ...
    $GLOBALS['TL_LANG']['tl_ls_shop_payment_methods']['payPalCheckout_updateInfo']                  = 'When setting up PayPal Checkout, please refer to the update notice at <a href="https://www.merconis.com/techsupport/contao-handbuch-onlineshop-v4/merconis-einstellungen/zahlungsoptionen/paypal-checkout.html" target="_blank">www.merconis.com/techsupport/</a>.';
 ...
 */
	...
	$GLOBALS['TL_LANG']['tl_ls_shop_payment_methods']['type']['options'] = array(
        ...
        'PayPal Checkout' => array('Payment via PayPal Checkout'),
