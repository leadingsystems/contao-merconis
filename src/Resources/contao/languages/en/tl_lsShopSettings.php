<?php
	...
	$GLOBALS['TL_LANG']['tl_lsShopSettings']['merconis_licenseKey']				= array('License key', 'Please enter the license key here (signed license key or legacy serial number).');
	...
	$GLOBALS['TL_LANG']['tl_lsShopSettings']['ls_shop_cartPositionCommentsEnabled'] = ['Enable comment field for cart items', 'Disable this option to hide item comments across the active shopping flow and ignore incoming comment input. Comments already stored on completed orders remain visible.'];
	...
	$GLOBALS['TL_LANG']['tl_lsShopSettings']['ls_shop_withdrawalPages']		= array('Page "Withdrawal"', 'Select the page that contains the module "Withdrawal". Should you run a multilingual shop, please select the corresponding page for each language.');
	$GLOBALS['TL_LANG']['tl_lsShopSettings']['ls_shop_withdrawalConfirmationPages']		= array('Page "Withdrawal confirmation"', 'Select the page that contains the module "Withdrawal confirmation". Should you run a multilingual shop, please select the corresponding page for each language.');
