<?php
    ...
    $GLOBALS['TL_LANG']['tl_lsShopSettings']['ls_shop_defaultProductPage'] = array('Page "Standard Product Page"', 'Select the page on which products are to be displayed that are not assigned to any pages or are only assigned to unpublished pages.');
