...
$GLOBALS['TL_LANG']['tl_lsShopSettings']['ls_shop_esLogFile'] = array('Log file path (optional)', 'If empty, logs go to PHP error_log. Provide an absolute path to write JSON lines.');
