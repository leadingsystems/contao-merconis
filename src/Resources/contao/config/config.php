...
if (TL_MODE === 'FE') {
	...
	$GLOBALS['LS_API_HOOKS']['apiReceiver_processRequest'][] = array('Merconis\Core\ls_shop_apiController_variationSelector', 'processRequest');
	...
	$GLOBALS['LS_API_HOOKS']['apiReceiver_processRequest'][] = array('Merconis\Core\ls_shop_apiController_searchEngine', 'processRequest');
}
