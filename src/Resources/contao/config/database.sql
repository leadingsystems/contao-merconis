...
CREATE TABLE `tl_ls_shop_product` (
    ...
    `searchVariantKeywords` mediumtext NULL,
    `searchVariantDescriptions` mediumtext NULL,
    `searchVariantTitles` mediumtext NULL,
    `searchAttributeValuesVariants` mediumtext NULL,
    `searchAttributeValues` mediumtext NULL,
	PRIMARY KEY  (`id`),
