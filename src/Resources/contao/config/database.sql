...
CREATE TABLE `tl_ls_shop_payment_methods` (
  ...
  `paypalAPIUsername` text NULL,
  `paypalAPIPassword` text NULL,
  `paypalAPISignature` text NULL,
  `paypalShipToFieldNameFirstname` text NULL,
  `paypalShipToFieldNameLastname` text NULL,
  `paypalShipToFieldNameStreet` text NULL,
  `paypalShipToFieldNameCity` text NULL,
  `paypalShipToFieldNamePostal` text NULL,
  `paypalShipToFieldNameState` text NULL,
  `paypalShipToFieldNameCountryCode` text NULL,
  ...
  `sofortueberweisungConfigkey` text NULL,
  `sofortueberweisungUseCustomerProtection` char(1) NOT NULL default '',
  `santanderWebQuickVendorNumber` text NULL,
  `santanderWebQuickVendorPassword` text NULL,
  `santanderWebQuickLiveMode` char(1) NOT NULL default '',
  `santanderWebQuickMinAge` int(10) unsigned NOT NULL default '18',
  `santanderWebQuickFieldNameSalutation` text NULL,
  `santanderWebQuickFieldNameFirstName` text NULL,
  `santanderWebQuickFieldNameLastName` text NULL,
  `santanderWebQuickFieldNameEmailAddress` text NULL,
  `santanderWebQuickFieldNameStreet` text NULL,
  `santanderWebQuickFieldNameCity` text NULL,
  `santanderWebQuickFieldNameZipCode` text NULL,
  `santanderWebQuickFieldNameCountry` text NULL,
  `payPalPlus_clientID` text NULL,
  `payPalPlus_clientSecret` text NULL,
  `payPalPlus_liveMode` char(1) NOT NULL default '',
  `payPalPlus_logMode` varchar(255) NOT NULL default 'NONE',
  `payPalPlus_shipToFieldNameFirstname` text NULL,
  `payPalPlus_shipToFieldNameLastname` text NULL,
  `payPalPlus_shipToFieldNameStreet` text NULL,
  `payPalPlus_shipToFieldNameCity` text NULL,
  `payPalPlus_shipToFieldNamePostal` text NULL,
  `payPalPlus_shipToFieldNameState` text NULL,
  `payPalPlus_shipToFieldNameCountryCode` text NULL,
  `payPalPlus_shipToFieldNamePhone` text NULL,
  `payPalCheckout_clientID` text NULL,
  `payPalCheckout_clientSecret` text NULL,
  `payPalCheckout_liveMode` char(1) NOT NULL default '',
  `payPalCheckout_logMode` varchar(255) NOT NULL default 'NONE',
  `payPalCheckout_shipToFieldNameFirstname` text NULL,
  `payPalCheckout_shipToFieldNameLastname` text NULL,
  `payPalCheckout_shipToFieldNameStreet` text NULL,
  `payPalCheckout_shipToFieldNameCity` text NULL,
  `payPalCheckout_shipToFieldNamePostal` text NULL,
  `payPalCheckout_shipToFieldNameCountryCode` text NULL,
  `payPalCheckout_shipToFieldNameState` text NULL,
  `payone_subaccountId` text NULL,
  `payone_portalId` text NULL,
  `payone_key` text NULL,
  `payone_liveMode` char(1) NOT NULL default '',
  `payone_clearingtype` varchar(16) NOT NULL default '',
  `payone_fieldNameFirstname` text NULL,
  `payone_fieldNameLastname` text NULL,
  `payone_fieldNameCompany` text NULL,
  `payone_fieldNameStreet` text NULL,
  `payone_fieldNameAddressaddition` text NULL,
  `payone_fieldNameZip` text NULL,
  `payone_fieldNameCity` text NULL,
  `payone_fieldNameCountry` text NULL,
  `payone_fieldNameEmail` text NULL,
  `payone_fieldNameTelephonenumber` text NULL,
  `payone_fieldNameBirthday` text NULL,
  `payone_fieldNameGender` text NULL,
  `payone_fieldNamePersonalid` text NULL,
  `saferpay_username` text NULL,
  `saferpay_password` text NULL,
  `saferpay_customerId` text NULL,
  `saferpay_terminalId` text NULL,
  `saferpay_merchantEmail` text NULL,
  ...
  `vrpay_userId` text NULL,
  `vrpay_password` text NULL,
  `vrpay_token` text NULL,
  `vrpay_entityId` text NULL,
  ...
  `vrpay_fieldName_street1` text NULL,
  `vrpay_fieldName_city` text NULL,
  `vrpay_fieldName_postcode` text NULL,
  `vrpay_fieldName_country` text NULL,
  `vrpay_fieldName_givenName` text NULL,
  `vrpay_fieldName_surname` text NULL,
  PRIMARY KEY  (`id`),
) ENGINE=MyISAM;
