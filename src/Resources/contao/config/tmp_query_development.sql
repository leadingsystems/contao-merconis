/*
 Do me! Remove file when development of the related functionality is finished!
 */

WITH allocations_with_null_values AS (
    /*
     all pids and all attributes, only for products not variants, filling combinations that
...
WHERE (
    (av.attributeID = '31' AND av.attributeValueID = '7079') OR
    (av.attributeID = '32' AND av.attributeValueID = '0')
)
GROUP BY av.pid
